    ...
    ILogger<InsightFetcherService> logger) : BackgroundService
{
    ...
    private static readonly string[] Queries =
    {
        ...
        "콘진원 OR 콘텐츠진흥원 게임 지원",
        "미니게임 교육 OR 콘텐츠",
        "정부 IT OR 디지털 지원사업 교육",
        "에듀테크 투자 OR 신제품"
    };

    // 관련도 점수표 (제목+스니펫에 포함되면 가중치만큼 +)
    private static readonly Dictionary<string, int> RelevanceWeights = new(StringComparer.OrdinalIgnoreCase)
    {
        // 핵심 산업 (가장 높은 가중치)
        ["교육게임"] = 12, ["학습게임"] = 12, ["어린이게임"] = 11,
        ["교육업계"] = 9, ["에듀테크"] = 8, ["edtech"] = 8,
        // 정부/지원
        ["콘진원"] = 10, ["콘텐츠진흥원"] = 10, ["지원사업"] = 6,
        ["정부 IT"] = 6, ["정부지원"] = 5, ["과기정통부"] = 5, ["교육부"] = 5,
        // 분야 키워드
        ["미니게임"] = 7, ["게이미피케이션"] = 7, ["게이미피케이션"] = 7,
        ["코딩교육"] = 6, ["AI 학습"] = 5, ["AI교육"] = 5, ["디지털교육"] = 5,
        ["STEM"] = 4, ["에듀"] = 3,
        // 보조
        ["학습앱"] = 6, ["교육앱"] = 6, ["스마트러닝"] = 5, ["K-에듀테크"] = 7,
    };
